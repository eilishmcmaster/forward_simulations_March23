...
# This script goes through all of the run data generated by the simulations and returns the He values for a given range of Hos.
# It outputs a csv that contains the He given the Hos, along with generation and which simulation variables were used. 
# The output is used to make histograms showing the distribution of values, and can show how values do or do not approach the expected He. 
